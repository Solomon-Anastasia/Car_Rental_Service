...
import com.rentaride.carrental.registration.EmailSender;
...
public class RegistrationService {
    ...
    @Qualifier("emailConfirmationService")
    private final EmailSender emailSender;

    public RegistrationService(AppUserService appUserService, EmailValidator emailValidator, ConfirmationTokenService confirmationTokenService, @Qualifier("emailConfirmationService") EmailSender emailSender) {
    ...
    private String buildEmail(String name, String link) {
        ...
        emailBuilder.append("<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n")
                ...
                .append(name)
                .append(",</p>")
                .append("<p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> Thank you for registering. Please click on the below link to activate your account: </p>")
